...
# =========== We printed average coverage per 1kb in the Python Script - Now average depth per 1bp  =========== #
...
# Check to make sure the average depth per 1bp = same to average coverage per 1kb
average_depth_df1 <- mean(df1$depth, na.rm = TRUE)
average_depth_df2 <- mean(df2$depth, na.rm = TRUE)
average_depth_df3 <- mean(df3$depth, na.rm = TRUE)

cat("Average depth per 1bp in depth_1.csv:", average_depth_df1, "\n")
cat("Average depth per 1bp in depth_2.csv:", average_depth_df2, "\n")
cat("Average depth per 1bp in depth_3.csv:", average_depth_df3, "\n")